...
// typedef union 
// {
// 	ADS_Data ADS_data_Buffer[3000];
// 	unsigned char ADS_uc[60000];
// }ECG_BUFFER;

// int ADS_count = 0;

/*-------------------------------------------------*/
# define ECG_DATA_BUFFER_LEN 3000
# define ACC_DATA_BUFFER_LEN 300
...
struct Data_buffer
{
	union 
	{
		...
		unsigned char uc[66008];
	}Data[2];
};

struct Data_buffer *D_buff;
	...
	if(YES==data_log_started)
	{
		if(YES==timer_ticked_bhi)
		{
			...
			fprintf(data_file,"%d,%d,%d,", sensor1->vector_buffer[sensor1->vector_ri].x, sensor1->vector_buffer[sensor1->vector_ri].y,
					...
					D_buff->Data[acc_buffer_i]._data.acc_data[acc_data_i].sensor[0].x =sensor1->vector_buffer[sensor1->vector_ri].x;
					D_buff->Data[acc_buffer_i]._data.acc_data[acc_data_i].sensor[0].y =sensor1->vector_buffer[sensor1->vector_ri].y;
					D_buff->Data[acc_buffer_i]._data.acc_data[acc_data_i].sensor[0].z =sensor1->vector_buffer[sensor1->vector_ri].z;
			...
			fprintf(data_file,"%d,%d,%d,", sensor2->vector_buffer[sensor2->vector_ri].x, sensor2->vector_buffer[sensor2->vector_ri].y,
					...
					D_buff->Data[acc_buffer_i]._data.acc_data[acc_data_i].sensor[1].x =sensor1->vector_buffer[sensor2->vector_ri].x;
					D_buff->Data[acc_buffer_i]._data.acc_data[acc_data_i].sensor[1].y =sensor1->vector_buffer[sensor2->vector_ri].y;
					D_buff->Data[acc_buffer_i]._data.acc_data[acc_data_i].sensor[1].z =sensor1->vector_buffer[sensor2->vector_ri].z;
			...
			fprintf(data_file,"%d,%d,%d,", sensor3->vector_buffer[sensor3->vector_ri].x, sensor3->vector_buffer[sensor3->vector_ri].y,
					...
					D_buff->Data[acc_buffer_i]._data.acc_data[acc_data_i].sensor[2].x =sensor1->vector_buffer[sensor3->vector_ri].x;
					D_buff->Data[acc_buffer_i]._data.acc_data[acc_data_i].sensor[2].y =sensor1->vector_buffer[sensor3->vector_ri].y;
					D_buff->Data[acc_buffer_i]._data.acc_data[acc_data_i].sensor[2].z =sensor1->vector_buffer[sensor3->vector_ri].z;
			...
			fprintf(data_file,"%d,%d,%d,", sensor4->vector_buffer[sensor4->vector_ri].x, sensor4->vector_buffer[sensor4->vector_ri].y,
					...
					D_buff->Data[acc_buffer_i]._data.acc_data[acc_data_i].sensor[3].x =sensor1->vector_buffer[sensor4->vector_ri].x;
					D_buff->Data[acc_buffer_i]._data.acc_data[acc_data_i].sensor[3].y =sensor1->vector_buffer[sensor4->vector_ri].y;
					D_buff->Data[acc_buffer_i]._data.acc_data[acc_data_i].sensor[3].z =sensor1->vector_buffer[sensor4->vector_ri].z;
			...
			fprintf(data_file,"%d,%d,%d,", sensor5->vector_buffer[sensor5->vector_ri].x, sensor5->vector_buffer[sensor5->vector_ri].y,
					...
					D_buff->Data[acc_buffer_i]._data.acc_data[acc_data_i].sensor[4].x =sensor1->vector_buffer[sensor4->vector_ri].x;
					D_buff->Data[acc_buffer_i]._data.acc_data[acc_data_i].sensor[4].y =sensor1->vector_buffer[sensor4->vector_ri].y;
					D_buff->Data[acc_buffer_i]._data.acc_data[acc_data_i].sensor[4].z =sensor1->vector_buffer[sensor4->vector_ri].z;
			...
			{
				printf("ACC batch - %d\n", acc_batch_i);
				if(ecg_batch_i == (acc_batch_i+1))
				{
					if(YES==is_tcp_client_connected())
					{
						write_tcp_thread_safe(D_buff->Data[acc_buffer_i].uc, 66008);
					 	printf("\nBuffer %d data transmitted successfully!\n", acc_buffer_i);
					}
				}
				D_buff->Data[acc_data_i]._data.acc_data_batch = acc_batch_i++;
				acc_buffer_i++;
				if(acc_buffer_i>1)
				{
					acc_buffer_i = 0;
	...
	if(YES==data_log_started)
	{
		if(YES==timer_ticked_ads)
		{
			...
			fflush(data_file);
				...
				D_buff->Data[ecg_batch_i]._data.ecg_data[ecg_data_i].la = ads1298->adc_buffer[ads1298->adc_ri].channel[3];
				D_buff->Data[ecg_batch_i]._data.ecg_data[ecg_data_i].ll = ads1298->adc_buffer[ads1298->adc_ri].channel[4];
				D_buff->Data[ecg_batch_i]._data.ecg_data[ecg_data_i].ra = ads1298->adc_buffer[ads1298->adc_ri].channel[5];
				D_buff->Data[ecg_batch_i]._data.ecg_data[ecg_data_i].v1 = ads1298->adc_buffer[ads1298->adc_ri].channel[7];
			...
			{
				printf("ECG batch - %d\n", ecg_batch_i);
				if(acc_batch_i == (ecg_batch_i+1))
				{
					if(YES==is_tcp_client_connected())
					{
						write_tcp_thread_safe(D_buff->Data[ecg_buffer_i].uc, 66008);
					 	printf("\nBuffer %d data transmitted successfully!\n", ecg_buffer_i);
					}
				}
				D_buff->Data[ecg_buffer_i]._data.ecg_data_batch = ecg_batch_i++;
				ecg_buffer_i++;
				if(ecg_buffer_i>1)
				{
					ecg_buffer_i = 0;
